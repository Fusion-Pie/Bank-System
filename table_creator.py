...
bank_cur.execute("Create table Loan_Users (User_id int, Loan_approved int, EMI Varchar(15) , Total_repay_amount int, Loan_issue_date Varchar(15), Loan_Period int)")
