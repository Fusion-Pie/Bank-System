...
bank_cur.execute("Create table Loan_Users (User_id int, Loan_approved int, EMI Varchar(15) , Total_repay_amount int, Loan_issue_date Varchar(15), Loan_Period int , Remaining_Period int)")
...
bank_cur.execute("Create table trans_history(User_id int, Transaction int, Trans_status varchar(2), Date varchar(15))")
